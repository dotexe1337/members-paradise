...
namespace HandlingEditor.Client
{
    internal class HandlingMenu : BaseScript
    {
        ...
        private void InitializeMenu()
        {
            if (editorMenu == null)
            {
                editorMenu = new Menu(" ", "Editor");
                editorMenu.HeaderTexture = new KeyValuePair<string, string>("mp_header", "mp_header");
            ...
            {
                personalPresetsMenu = new Menu(" ", "Personal Presets");
                personalPresetsMenu.HeaderTexture = new KeyValuePair<string, string>("mp_header", "mp_header");
            ...
            {
                serverPresetsMenu = new Menu(" ", "Server Presets");
                serverPresetsMenu.HeaderTexture = new KeyValuePair<string, string>("mp_header", "mp_header");
